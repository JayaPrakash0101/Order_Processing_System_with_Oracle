...
public class OrdersReport extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String col[] = {"Order ID", "Customer ID", "Order date", "Product ID", "Quantity", "Order status"};
   ...
   int custId = list.get(i).getCustid();
   String ordDate = list.get(i).getOrderdate();
   int prodId = list.get(i).getProdid();
   int qty = list.get(i).getQty();
   String orderStatus = list.get(i).getOrderstatus();
   Object data[] = {ordId, custId, ordDate, prodId, qty, orderStatus};
